        ...
        <section class="section">
          <div class="section-header">
            ...
            <div class="section-header-breadcrumb">
              ...
              <div class="breadcrumb-item">{{__('admin.Services')}}</div>
            </div>
          </div>

          <div class="section-body">
            <a href="{{route('seller.service.index') }}" class="btn btn-primary"><i class="fas fa-list"></i> {{__('admin.Services')}}</a>
            <div class="row mt-4">
                <div class="col-12">
                  <div class="card">
                    <div class="card-body">
                        <form action="{{ route('seller.service.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                ...
                                <div class="form-group col-12">
                                    ...
                                    <div>
                                        <input type="checkbox"name="top_service" id="top_service"> <label for="top_service" class="mr-3" >{{__('admin.Top Service')}}</label>

                                        <input type="checkbox" name="new_arrival" id="new_arrival"> <label for="new_arrival" class="mr-3" >{{__('admin.New Arrival')}}</label>

                                        <input type="checkbox" name="best_service" id="best_service"> <label for="best_service" class="mr-3" >{{__('admin.Best Service')}}</label>

                                        <input type="checkbox" name="is_featured" id="is_featured"> <label for="is_featured" class="mr-3" >{{__('admin.Featured Service')}}</label>
                                    </div>
                                </div>
