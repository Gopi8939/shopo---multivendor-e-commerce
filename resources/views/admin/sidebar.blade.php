...
<div class="main-sidebar">
    <aside id="sidebar-wrapper">
      ...
      <ul class="sidebar-menu">
          ...
          <li class="nav-item dropdown {{ Route::is('admin.service.*') || Route::is('admin.service-brand.*') || Route::is('admin.service-variant') || Route::is('admin.create-service-variant') || Route::is('admin.edit-service-variant') || Route::is('admin.service-gallery') || Route::is('admin.service-variant-item') || Route::is('admin.create-service-variant-item') || Route::is('admin.edit-service-variant-item') || Route::is('admin.service-review') || Route::is('admin.show-service-review') || Route::is('admin.seller-service') || Route::is('admin.seller-pending-service') || Route::is('admin.wholesale') || Route::is('admin.create-wholesale') || Route::is('admin.edit-wholesale') || Route::is('admin.service-highlight') ||  Route::is('admin.service-report') || Route::is('admin.show-service-report') || Route::is('admin.specification-key.*') || Route::is('admin.stockout-service') || Route::is('admin.service-import-page') ? 'active' : '' }}">
            ...
            <li><a class="nav-link" href="{{ route('admin.service.create') }}">{{__('admin.Create Service')}}</a></li>

            <li class="{{ Route::is('admin.service.*') || Route::is('admin.service-variant') || Route::is('admin.create-service-variant') || Route::is('admin.edit-service-variant') || Route::is('admin.service-gallery') || Route::is('admin.service-variant-item') || Route::is('admin.create-service-variant-item') || Route::is('admin.edit-service-variant-item') || Route::is('admin.wholesale') || Route::is('admin.create-wholesale') || Route::is('admin.edit-wholesale') || Route::is('admin.service-highlight') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.service.index') }}">{{__('admin.Services')}}</a></li>
          ...
          <li class="nav-item dropdown {{ Route::is('admin.sistas-service.*') || Route::is('admin.maintainance-mode') || Route::is('admin.announcement') ||  Route::is('admin.slider.*') || Route::is('admin.home-page') || Route::is('admin.banner-image.index') || Route::is('admin.homepage-one-visibility') || Route::is('admin.cart-bottom-banner') || Route::is('admin.shop-page') || Route::is('admin.seo-setup') || Route::is('admin.menu-visibility') || Route::is('admin.product-detail-page') || Route::is('admin.default-avatar') || Route::is('admin.seller-conditions') || Route::is('admin.subscription-banner') || Route::is('admin.testimonial.*') || Route::is('admin.homepage-section-title') || Route::is('admin.image-content') ? 'active' : '' }}">
            ...
            <ul class="dropdown-menu">
                ...
                <li class="{{ Route::is('admin.sistas-service.*') ? 'active' : '' }}"><a class="nav-link" href="{{ route('admin.sistas-service.index') }}">{{__('admin.Sistas Services')}}</a></li>
