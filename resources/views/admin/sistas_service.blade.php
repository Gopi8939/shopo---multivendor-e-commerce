      ...
      <div class="main-content">
        <section class="section">
          <div class="section-header">
            <h1>{{__('admin.Sistas Services')}}</h1>
          ...
          <div class="section-body">
            <a href="{{ route('admin.sistas-service.create') }}" class="btn btn-primary"><i class="fas fa-plus"></i> {{__('admin.Add New')}}</a>
            <div class="row mt-4">
                <div class="col">
                  <div class="card">
                    <div class="card-body">
                            ...
                            <tbody>
                                @foreach ($services as $index => $service)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{ route('admin.sistas-service.edit',$service->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-edit" aria-hidden="true"></i></a>
...
<script>
    function deleteData(id){
        $("#deleteForm").attr("action",'{{ url("admin/sistas-service/") }}'+"/"+id)
    }
    function changeServiceStatus(id){
        ...
        $.ajax({
            ...
            url:"{{url('/admin/sistas-service-status/')}}"+"/"+id,
