...
use App\Http\Controllers\Admin\SistasServiceController;
...
Route::group(['as'=> 'admin.', 'prefix' => 'admin'],function (){
    ...
    // Route::resource('service', SistasServiceController::class);
    // Route::put('service-status/{id}', [SistasServiceController::class,'changeStatus'])->name('service.status');
