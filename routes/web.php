...
use App\Http\Controllers\WEB\Admin\SistasServiceController;
...
use App\Http\Controllers\WEB\Seller\SellerServiceController;
...
Route::group(['middleware' => ['maintainance']], function () {
    ...
    Route::group(['as'=> 'seller.', 'prefix' => 'seller'],function (){
        ...
        Route::put('service-status/{id}', [ SellerServiceController::class,'changeStatus'])->name('service.status');
...
Route::group(['as'=> 'admin.', 'prefix' => 'admin'],function (){
    ...
    Route::resource('sistas-service', SistasServiceController::class);
    Route::put('sistas-service-status/{id}', [SistasServiceController::class,'changeStatus'])->name('sistas-service.status');
